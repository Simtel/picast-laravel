...
- **Tools** — developer utilities: barcode generator (Code 128, EAN-13 and more), timestamp converter, random string generator, UUID generator, color converter, JSON diff
