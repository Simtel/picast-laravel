    ...
    <div class="row">
        <div class="col-sm-12 mt-15">
            <div class="jumbotron">
                <h3>Внимание</h3>
                <ul>
                    <li>Все данные загружаемые в A&amp;S Tech одновременно копируются на несколько независимых серверов.
                    </li>
                    <li>Пользователи A&amp;S Tech получают картинки на скорости более 10 Гбит/с.</li>
                    <li>Нет рекламы!</li>
